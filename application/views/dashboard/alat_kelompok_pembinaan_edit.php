                    ...
                    <div class="tab-content tab-content-basic">
                        ...
                        <div class="row tabel-produk mt-2">
                            <div class="col-lg-8 grid-margin stretch-card">
                                <div class="card">
                                    <form method="post" action="<?= base_url('dashboard/update_alat_kelompok_pembinaan/' . $alat_kelompok[0]['id']); ?>">
                                        <div class="card-body">
                                            <h4 class="card-title">
                                                Edit Alat Kelompok Pembinaan
                                            </h4>
                                            ...
                                            <div class="mb-3">
                                                <select class="form-control" name="jenis_alat">
                                                    ...
                                                    <?php foreach ($jenis_alat as $alat) : ?>
                                                        <option value="<?= $alat['id'] ?>" <?= $alat['id'] == $alat_kelompok[0]['Jenis_alat'] ? 'selected' : '' ?>>
                                                            <?= $alat['jenis_alat'] ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>

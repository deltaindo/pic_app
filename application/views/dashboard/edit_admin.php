                                ...
                                <div class="card">
                                    <form method="post" action="<?= base_url('dashboard/update_admin/' . $admin[0]['id']); ?>">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" class="form-control" name="admin_name" value="<?= $admin[0]['nama'] ?>" placeholder="Inputkan Nama Admin" autofocus>
                                            </div>
                                            <label for="email_admin" class="text-primary fs-6 mb-1">
                                                Email
                                            </label>
                                            <div class="mb-3">
                                                <input type="email" class="form-control" id="email_admin" aria-describedby="email_admin" name="email_admin" value="<?= $admin[0]['email'] ?>" autocomplete="off">
                                            </div>
                                            <label for="mobilephone_admin" class="text-primary fs-6 mb-1">
                                                Mobilephone
                                            </label>
                                            <div class="mb-3">
                                                <input type="text" class="form-control" id="mobilephone_admin" aria-describedby="mobilephone_admin" value="<?= $admin[0]['phone_number'] ?>" name="mobilephone_admin" autocomplete="off">
                                            </div>

                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form id="bulk-delete-form" action="<?= base_url('dashboard/hapus_bulk_jenis_alat'); ?>" method="post">
                      ...
                      <button class="btn btn-danger text-white" type="button" onclick="deleteBulkJenisAlat()">
                        Hapus
                      </button>
                      <a href="<?= base_url('report/jenis_alat_excel'); ?>" class="btn btn-success text-white" type="button">
                        Export Excel
                      </a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="<?= base_url('dashboard/simpanJenisAlat'); ?>">
            ...
            <div class="mb-3">
              <input type="text" class="form-control" id="jenis_alat" aria-describedby="jenis_alat" name="jenis_alat" placeholder="Masukkan Jenis Alat">
            </div>
        </div>

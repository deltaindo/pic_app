                    ...
                    <div class="tab-content tab-content-basic">
                        ...
                        <div class="row tabel-produk mt-2">
                            <div class="col-lg-8 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Daftar Jenis Personil</h4>
                                        ...
                                        <form id="bulk-delete-form" action="<?= base_url('dashboard/hapus_bulk_jenis_personil'); ?>" method="post">
                                            ...
                                            <button class="btn btn-danger text-white" type="button" onclick="deleteBulkJenisPersonil()">Hapus</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="<?= base_url('dashboard/jenis_personil_simpan'); ?>">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" id="nama_jenis_personil" aria-describedby="nama_jenis_personil" name="nama_jenis_personil" autofocus>
                        </div>
                </div>

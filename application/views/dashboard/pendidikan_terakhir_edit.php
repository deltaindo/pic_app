                    ...
                    <div class="tab-content tab-content-basic">
                        ...
                        <div class="row tabel-produk mt-2">
                            <div class="col-lg-8 grid-margin stretch-card">
                                <div class="card">
                                    <form method="post" action="<?= base_url('dashboard/update_pendidikan_terakhir/' . $kelas_pendidikan[0]['id']); ?>">
                                        <div class="card-body">
                                            <h4 class="card-title">
                                                Edit Kelas Pendidikan Terakhir
                                            </h4>
                                            ...
                                            <div class="mb-3">
                                                <select class="form-control" name="nama_kelas">
                                                    ...
                                                    <?php foreach ($semuakelas as $kelas) : ?>
                                                        <option value="<?= $kelas['id'] ?>" <?= $kelas['id'] == $kelas_pendidikan[0]['id_kelas'] ? 'selected' : '' ?>>
                                                            <?= $kelas['kelas'] ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                <select class="form-control" name="nama_pendidikan">
                                                    ...
                                                    <?php foreach ($semuapendidikan as $pendidikan) : ?>
                                                        <option value="<?= $pendidikan['id'] ?>" <?= $pendidikan['id'] == $kelas_pendidikan[0]['id_pendidikan'] ? 'selected' : '' ?>>

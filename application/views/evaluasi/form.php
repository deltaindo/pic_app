        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Evaluasi Penyelenggara Pelatihan Online Delta Indonesia</h4>
              <?= $this->session->userdata('message'); ?>
              <form class="pt-3" method="post" action="<?= base_url('evaluasi/form'); ?>">
              ...
              <?php endforeach; ?>
                ...
                <div class="form-group">
                  <label for="">Kesan Pertama</label>
                  <input type="text" name="kesan" class="form-control form-control-lg" id="exampleInputEmail1">
                </div>
                <div class="form-group">

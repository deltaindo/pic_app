  ...
  <body className="snippet-body">
            ...
            <div class="main active">
             ...
             style="width: 160px; height: 100px;">
              ...
              <div class="input-text">
                <div class="input-div">
                  <input type="text" placeholder="nama sesuai ktp" id="user_name" name="nama" require />
             ...
             style="width: 80px; height: 50px;">
              ...
              <div class="input-text">
                <div class="input-div">
                  ...
                  <a href="https://docs.google.com/document/d/1umWYMsPKDa2rTHweljrQInl7gJhkzLVh/edit?pli=1" target="_blank" class="text-danger"
    ...
    $(document).ready(function(){
      ...
      function capitalizeText(input) {
        ...
        input.val(inputValue.toUpperCase());
      }

      // Fungsi untuk mengikat perubahan isian input
      function bindCapitalizeEvent(input) {
        input.on('input', function() {
          capitalizeText($(this));
        });
      }

      // Fungsi untuk mengikat perubahan isian untuk setiap elemen input
      function bindCapitalizeEvents() {
        var inputSelectors = [
          '#user_name', '[name="nik"]', '[name="tempat_lahir"]', '[name="nama_sekolah"]',
          '[name="provinsi"]', '[name="kabupaten"]', '[name="kecamatan"]', '[name="kelurahan"]',
          '[name="alamat_rumah"]', '#companyName', '[name="sektor"]', '[name="alamat_perusahaan"]',
          '[name="jabatan"]', '[name="tlp_kantor"]', '[name="wa"]'
        ];

        inputSelectors.forEach(function(selector) {
          bindCapitalizeEvent($(selector));
        });
      }

      // Panggil fungsi untuk mengikat perubahan isian saat dokumen dimuat

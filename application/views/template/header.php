...
<link
      rel="stylesheet"
      href="<?= base_url('assets/vendors/simple-line-icons/css/simple-line-icons.css'); ?>"
    />
    ...
    <link
      rel="stylesheet"
      href="<?= base_url('assets/vendors/datatables.net-bs4/dataTables.bootstrap4.css'); ?>"
    />
...
#example td:nth-child(4) {
  position: sticky;
  left: 0;
  background-color: #f8f9fa; /* Ganti dengan warna latar yang sesuai */
  z-index: 1;
}
    </style>
        ...
        >
          ...
          <div>
            <a class="navbar-brand brand-logo" href="<?= base_url('dashboard'); ?>">
              <img
                src="<?= base_url('assets/images/logo-delta.png'); ?>"
                alt="logo"
                style="height: 100px"
              />
            </a>
          ...
          <div class="tab-content" id="setting-content">
            ...
            >
              ...
              >
                ...
                <small
                  class="settings-heading border-top-0 mb-3 pt-0 border-bottom-0 pb-0 pr-3 fw-normal"
                  >See All</small
                >
              </div>
              <ul class="chat-list">
